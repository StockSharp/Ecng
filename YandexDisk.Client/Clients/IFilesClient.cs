...
namespace YandexDisk.Client.Clients
{
    ...
    public interface IFilesClient
    {
        ...
        /// <summary>
        /// Upload file to Disk on link received by <see cref="GetUploadLinkAsync"/>
        /// </summary>
        [PublicAPI, NotNull]
        ...
        /// </summary>
        /// <param name="path">Path to downloading file on Disk</param>
        /// <param name="cancellationToken"></param>
        [PublicAPI, NotNull]
        Task<Link> GetDownloadLinkAsync([NotNull] string path, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Download file from Disk on link received by <see cref="GetDownloadLinkAsync"/>
        /// </summary>
        [PublicAPI, NotNull]
