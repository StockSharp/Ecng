...
[![Telegram Chat](https://img.shields.io/badge/Telegram-Chat-blue?logo=telegram)](https://stocksharp.com/en/chat/)
...
- **Ecng.Data.Ado** [![NuGet](https://img.shields.io/nuget/v/Ecng.Data.Ado.svg)](https://www.nuget.org/packages/Ecng.Data.Ado) [![NuGet](https://img.shields.io/nuget/dt/Ecng.Data.Ado.svg)](https://www.nuget.org/packages/Ecng.Data.Ado) – ADO.NET based data access providers.
...
- **Ecng.Excel** [![NuGet](https://img.shields.io/nuget/v/Ecng.Excel.svg)](https://www.nuget.org/packages/Ecng.Excel) [![NuGet](https://img.shields.io/nuget/dt/Ecng.Excel.svg)](https://www.nuget.org/packages/Ecng.Excel) – abstractions for Excel file operations.
- **Ecng.Excel.DX** [![NuGet](https://img.shields.io/nuget/v/Ecng.Excel.DX.svg)](https://www.nuget.org/packages/Ecng.Excel.DX) [![NuGet](https://img.shields.io/nuget/dt/Ecng.Excel.DX.svg)](https://www.nuget.org/packages/Ecng.Excel.DX) – Excel provider using DevExpress.
- **Ecng.Excel.OpenXml** [![NuGet](https://img.shields.io/nuget/v/Ecng.Excel.OpenXml.svg)](https://www.nuget.org/packages/Ecng.Excel.OpenXml) [![NuGet](https://img.shields.io/nuget/dt/Ecng.Excel.OpenXml.svg)](https://www.nuget.org/packages/Ecng.Excel.OpenXml) – Excel provider using OpenXml SDK.
...
- **Ecng.IO.Compression** [![NuGet](https://img.shields.io/nuget/v/Ecng.IO.Compression.svg)](https://www.nuget.org/packages/Ecng.IO.Compression) [![NuGet](https://img.shields.io/nuget/dt/Ecng.IO.Compression.svg)](https://www.nuget.org/packages/Ecng.IO.Compression) – LZMA and other compression utilities.
...
- **Ecng.Net.Udp** [![NuGet](https://img.shields.io/nuget/v/Ecng.Net.Udp.svg)](https://www.nuget.org/packages/Ecng.Net.Udp) [![NuGet](https://img.shields.io/nuget/dt/Ecng.Net.Udp.svg)](https://www.nuget.org/packages/Ecng.Net.Udp) – UDP protocol helpers and multicast support.
...
- **Ecng.SmartFormat** [![NuGet](https://img.shields.io/nuget/v/Ecng.SmartFormat.svg)](https://www.nuget.org/packages/Ecng.SmartFormat) [![NuGet](https://img.shields.io/nuget/dt/Ecng.SmartFormat.svg)](https://www.nuget.org/packages/Ecng.SmartFormat) – advanced string formatting library.
- **Ecng.StringSearch** [![NuGet](https://img.shields.io/nuget/v/Ecng.StringSearch.svg)](https://www.nuget.org/packages/Ecng.StringSearch) [![NuGet](https://img.shields.io/nuget/dt/Ecng.StringSearch.svg)](https://www.nuget.org/packages/Ecng.StringSearch) – efficient string search algorithms.
