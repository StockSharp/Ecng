...
namespace Ecng.Net.SocketIO.Client
{
    public class Manager : Emitter
    {
        ...
        private Ecng.Net.SocketIO.Engine.Client.Socket.Options Opts;
        private bool AutoConnect;
        private HashSet<Socket> OpeningSockets;
        /*package*/

        public Ecng.Net.SocketIO.Engine.Client.Socket EngineSocket;
        ...
        private Manager Open(IOpenCallback fn)
        {
            ...
            var openSub = Ecng.Net.SocketIO.Client.On.Create(socket, Engine.EVENT_OPEN, new ListenerImpl(() =>
            {
                OnOpen();
                if (fn != null)
                {
    ...
    public class Engine : Ecng.Net.SocketIO.Engine.Client.Socket
    {
    ...
    public class Options : Ecng.Net.SocketIO.Engine.Client.Socket.Options
    {
