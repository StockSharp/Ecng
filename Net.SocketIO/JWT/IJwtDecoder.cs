...
namespace JWT
{
    ...
    public interface IJwtDecoder
    {
        ...
        /// <param name="verify">Whether to verify the signature (default is true)</param>
        /// <returns>A string containing the JSON payload</returns>
        string Decode(string token, ICollection<byte[]> keys, bool verify);
        ...
        /// <exception cref="SignatureVerificationException">Thrown if the verify parameter was true and the signature was NOT valid or if the JWT was signed with an unsupported algorithm</exception>
        /// <exception cref="TokenExpiredException">Thrown if the verify parameter was true and the token has an expired exp claim</exception>
        IDictionary<string, object> DecodeToObject(string token, ICollection<byte[]> keys, bool verify);
        ...
        /// <exception cref="SignatureVerificationException">Thrown if the verify parameter was true and the signature was NOT valid or if the JWT was signed with an unsupported algorithm</exception>
        /// <exception cref="TokenExpiredException">Thrown if the verify parameter was true and the token has an expired exp claim</exception>
        T DecodeToObject<T>(string token, ICollection<byte[]> keys, bool verify);
