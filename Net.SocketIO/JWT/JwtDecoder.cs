...
namespace JWT
{
    ...
    public sealed class JwtDecoder : IJwtDecoder
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException" />
        /// <exception cref="FormatException" />
        public string Decode(string token, ICollection<byte[]> keys, bool verify)
        {
            if (String.IsNullOrWhiteSpace(token))
                throw new ArgumentException(nameof(token));
            if (keys is null)
        ...
        /// <exception cref="ArgumentOutOfRangeException" />
        /// <exception cref="FormatException" />
        public IDictionary<string, object> DecodeToObject(string token, ICollection<byte[]> keys, bool verify) =>
        ...
        /// <exception cref="ArgumentOutOfRangeException" />
        /// <exception cref="FormatException" />
        public T DecodeToObject<T>(string token, ICollection<byte[]> keys, bool verify)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException" />
        /// <exception cref="FormatException" />
        public void Validate(JwtParts jwt, ICollection<byte[]> keys)
        {
            if (jwt is null)
                throw new ArgumentNullException(nameof(jwt));
            if (keys is null)
