...
namespace xNet
{
    ...
    public sealed class HttpResponse
    {
        ...
        /// </summary>
        /// <remarks>Если куки были установлены в <see cref="xNet.Net.HttpRequest"/> и значение свойства <see cref="CookieDictionary.IsLocked"/> равно <see langword="true"/>, то будут созданы новые куки.</remarks>
