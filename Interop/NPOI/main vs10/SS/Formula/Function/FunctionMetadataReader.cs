...
//        private const String METADATA_FILE_NAME = "NPOI.functionMetadata.txt";//+++
//        private  string METADATA_FILE_NAME = "functionMetadata.txt";
//        private  String METADATA_FILE_NAME = "functionMetadata.txt";
        ...
        {
            string metaFile = "";
            var ResourceNames = typeof (FunctionMetadataReader).Assembly.GetManifestResourceNames();
            foreach (var name in ResourceNames) metaFile = name.Contains(METADATA_FILE_NAME) ? name : metaFile;

            var ads  = ResourceNames[0].Contains(METADATA_FILE_NAME);
            ...
            using (
                StreamReader br =
                    new StreamReader(
                        typeof (FunctionMetadataReader).Assembly.GetManifestResourceStream(metaFile)))
            {
