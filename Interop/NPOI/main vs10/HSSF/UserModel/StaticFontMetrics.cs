...
namespace NPOI.HSSF.UserModel
{
    ...
    {
//        const string FONT_METRICS_PROPERTIES_FILE_NAME = "NPOI.NPOI.main_vs10.Resources.font_metrics.properties";//+++
        ...
        public static FontDetails GetFontDetails(Font font)
        {
            ...
            string metaFile = "";
            var ResourceNames = typeof(StaticFontMetrics).Assembly.GetManifestResourceNames();
            foreach (var name in ResourceNames) metaFile = name.Contains(FONT_METRICS_PROPERTIES_FILE_NAME) ? name : metaFile;
            ...
            if (fontMetricsProps == null)
            {
                ...
                try
                {
                    ...
                    if (propFileName != null)
                    {
                        ...
                        metricsIn = typeof(StaticFontMetrics).Assembly.GetManifestResourceStream(metaFile);
