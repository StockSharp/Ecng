...
namespace System.Linq
{
    ...
    public static class MoreEnumerable2
    {
        ...
        /// </remarks>
        public static HashSet<TSource> ToHashSet2<TSource>(this IEnumerable<TSource> source)
        {
            return source.ToHashSet2(null);
        }
        ...
        /// This evaluates the input sequence completely.
        /// </remarks>
        public static HashSet<TSource> ToHashSet2<TSource>(this IEnumerable<TSource> source, IEqualityComparer<TSource> comparer)
        {
