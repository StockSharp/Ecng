...
namespace System.Windows.Media.Imaging
{
        ...
        static partial class WriteableBitmapExtensions
    {
        ...
        private static void AALineQ1(int width, int height, BitmapContext context, int x1, int y1, int x2, int y2,
                                     Int32 color, bool minEdge, bool leftEdge)
        {
            Byte off = 0;
        ...
        private static void AAWidthLine(int width, int height, BitmapContext context, float x1, float y1, float x2,
                                        float y2, float lineWidth, Int32 color)
        {
        ...
        internal static void DrawLineAA(BitmapContext context, int pixelWidth, int pixelHeight,
                                        int x1, int y1, int x2, int y2, int color, int strokeThickness)
        {
            AAWidthLine(pixelWidth, pixelHeight, context, x1, y1, x2, y2, strokeThickness, color);
        }

        internal static void DrawLineAA(BitmapContext context, int pixelWidth, int pixelHeight,
                                        int x1, int y1, int x2, int y2, Color color, int strokeThickness)
        {
        ...
        internal static void DrawLineAA(this WriteableBitmap bmp,
                                        int x1, int y1, int x2, int y2, Color color, int strokeThickness)
        {
            // Add one to use mul and cheap bit shift for multiplicaltion
            int a = color.A + 1;
