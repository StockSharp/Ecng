...
//   Id:                $Id: WriteableBitmapBlitExtensions.cs 82056 2011-10-27 20:32:30Z unknown $
//
//
//   Copyright © 2009-2011 Bill Reiss, Rene Schulte and WriteableBitmapEx Contributors
//
                       ...
                       for (int i = 0; i < dw; i++)
                       {
                           if (x >= 0 && x < dpw)
                           {
                               ...
                               else if (blendMode == BlendMode.ColorKeying)
                               {
                                   ...
                                   if (sr != WhiteR || sg != WhiteG || sb != WhiteB)
                                   {
                                       destPixels[idx] = sourcePixel;
                                   }
