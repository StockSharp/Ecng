...
namespace MatterHackers.Agg
{
    ...
    //--------------------------------------------------------image_filter
    internal class image_filter : ImageFilterLookUpTable
    {
        public image_filter()
        {
    ...
    internal struct image_filter_hamming : IImageFilterFunction
    {
        public double radius() { return 1.0; }
        public double calc_weight(double x)
        {
    ...
    internal struct image_filter_hermite : IImageFilterFunction
    {
        public double radius() { return 1.0; }
        public double calc_weight(double x)
        {
    ...
    internal struct image_filter_gaussian : IImageFilterFunction
    {
        public double radius() { return 2.0; }
        public double calc_weight(double x) 
        {
    ...
    //------------------------------------------------image_filter_bessel
    internal struct image_filter_bessel : IImageFilterFunction
    {
