...
namespace MatterHackers.Agg.Transform
{
    ...
    internal struct Affine : ITransform
    {
        ...
        internal sealed class trans_affine_line_segment : Affine
        {
        ...
        internal class trans_affine_reflection_unit : Affine
        {
        ...
        internal sealed class trans_affine_reflection : trans_affine_reflection_unit
        {
