...
namespace MatterHackers.Agg.VertexSource
{
    ...
    internal class RoundedRect : IVertexSource
    {
        ...
        public RoundedRect(double left, double bottom, double right, double top, double radius)
        {
            ...
            leftBottomRadius.x = (radius); leftBottomRadius.y = (radius); rightBottomRadius.x = (radius); rightBottomRadius.y = (radius);
            rightTopRadius.x = (radius); rightTopRadius.y = (radius); leftTopRadius.x = (radius); leftTopRadius.y = (radius);
