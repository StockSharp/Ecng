...
namespace MatterHackers.Agg
{
    ...
    internal class span_image_filter_gray_nn_stepXby1 : span_image_filter
    {
        ...
        public override void generate(RGBA_Bytes[] span, int spanIndex, int x, int y, int len)
        {
            ...
            do
            {
                ...
                span[spanIndex].red = fg_ptr[bufferIndex++];
                span[spanIndex].green = fg_ptr[bufferIndex++];
                span[spanIndex].blue = fg_ptr[bufferIndex++];
                span[spanIndex].alpha = fg_ptr[bufferIndex++];
    ...
    /*
        ...
        internal class span_image_filter_gray_nn : span_image_filter // <Source, Interpolator>
        {
        ...
        //template<class Source, class Interpolator> 
        internal class span_image_filter_gray_bilinear : span_image_filter // <Source, Interpolator>
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
            //typedef Interpolator interpolator_type;
        ...
        //template<class Source, class Interpolator> 
        internal class span_image_filter_gray_bilinear_clip : span_image_filter // <Source, Interpolator>
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
            //typedef Interpolator interpolator_type;
        ...
        //template<class Source, class Interpolator> 
        internal class span_image_filter_gray_2x2 : span_image_filter//<Source, Interpolator>
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
            //typedef Interpolator interpolator_type;
        ...
        //template<class Source, class Interpolator> 
        internal class span_image_filter_gray : span_image_filter//<Source, Interpolator>
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
            //typedef Interpolator interpolator_type;
        ...
        internal class span_image_resample_gray_affine : span_image_resample_affine//<Source>
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
        ...
        //template<class Source, class Interpolator>
        internal class span_image_resample_gray : span_image_resample//<Source, Interpolator>
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
            //typedef Interpolator interpolator_type;
