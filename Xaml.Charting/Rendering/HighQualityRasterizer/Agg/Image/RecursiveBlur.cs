...
//        }
    ...
    internal abstract class RecursizeBlurCalculator
    {
    ...
    //===========================================================recursive_blur
    internal sealed class RecursiveBlur
    {
    ...
    internal sealed class recursive_blur_calc_rgb : RecursizeBlurCalculator
    {
    ...
    internal sealed class recursive_blur_calc_rgba : RecursizeBlurCalculator
    {
        public override RecursizeBlurCalculator CreateNew()
        {
    ...
    internal sealed class recursive_blur_calc_gray : RecursizeBlurCalculator
    {
        public override RecursizeBlurCalculator CreateNew()
        {
