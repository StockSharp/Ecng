...
namespace MatterHackers.Agg
{
    ...
    internal class span_image_filter_rgba_2x2 : span_image_filter//<Source, Interpolator>
    {
...
*/
    ...
    /*
        ...
        internal class span_image_resample_rgba_affine : span_image_resample_affine
        {
            //typedef Source source_type;
            //typedef typename source_type::color_type color_type;
            //typedef typename source_type::order_type order_type;
    ...
    internal class span_image_resample_rgba
        : span_image_resample
    {
        ...
        public span_image_resample_rgba(IImageBufferAccessor src,
            ...
            base(src, inter, filter)
        {
            if (src.SourceImage.GetBlender().NumPixelBits != 32)
            {
