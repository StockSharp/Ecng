...
namespace MatterHackers.Agg
{
    ...
    internal interface IColorFunction
    {
        int size();
    ...
    //==========================================================gradient_radial
    internal class gradient_radial : IGradient
    {
        public int calculate(int x, int y, int d)
        {
            //return (int)(System.Math.Sqrt((int)(x * x + y * y)));
            return (int)(agg_math.fast_sqrt((int)(x * x + y * y)));
        }
    };

    //========================================================gradient_radial_d
    internal class gradient_radial_d : IGradient
    {
        public int calculate(int x, int y, int d)
        {
    ...
    //==============================================================gradient_x
    internal class gradient_x : IGradient
    {
    ...
    //==============================================================gradient_y
    internal class gradient_y : IGradient
    {
        public int calculate(int x, int y, int d) { return y; }
    };

    //========================================================gradient_diamond
    internal class gradient_diamond : IGradient
    {
        public int calculate(int x, int y, int d) 
        { 
    ...
    //========================================================gradient_sqrt_xy
    internal class gradient_sqrt_xy : IGradient
    {
        public int calculate(int x, int y, int d) 
        {
    ...
    //==========================================================gradient_conic
    internal class gradient_conic : IGradient
    {
        public int calculate(int x, int y, int d) 
        { 
