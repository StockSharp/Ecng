...
// 
// ILabelFormatter.cs is part of Ultrachart, a High Performance WPF & Silverlight Chart. 
...
{
    /// <summary>
    /// Interface to define a LabelFormatter. The LabelFormatter may be set or data-bound to the <see cref="AxisBase.LabelFormatter"/> property, allowing
    /// programmatic overriding of axis labels. 
    /// 
    /// Create a class which implements <see cref="ILabelFormatter"/> and return string values from the <see cref="ILabelFormatter.FormatLabel"/> and <see cref="ILabelFormatter.FormatCursorLabel"/> methods
    /// </summary>
