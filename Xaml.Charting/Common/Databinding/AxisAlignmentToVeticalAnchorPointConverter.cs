...
// 
// AxisAlignmentToVeticalAnchorPointConverter.cs is part of Ultrachart, a High Performance WPF & Silverlight Chart. 
...
namespace Ecng.Xaml.Charting
{
    ...
    public class AxisAlignmentToVeticalAnchorPointConverter: IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var anchorPoint = VerticalAnchorPoint.Center;
            switch (axisAlignment)
            {
                case AxisAlignment.Top:
                case AxisAlignment.Bottom:
                    anchorPoint = VerticalAnchorPoint.Top;
                    break;
            }
