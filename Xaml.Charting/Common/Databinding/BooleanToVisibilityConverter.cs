...
// 
// BooleanToVisibilityConverter.cs is part of Ultrachart, a High Performance WPF & Silverlight Chart. 
...
namespace Ecng.Xaml.Charting
{
    ...
    public class BooleanToVisibilityConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var onTrue = inverse ? FalseVisibilityValue : Visibility.Visible;
            var onFalse = inverse ? Visibility.Visible : FalseVisibilityValue;
