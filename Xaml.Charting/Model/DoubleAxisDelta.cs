...
// 
// DoubleAxisDelta.cs is part of Ultrachart, a High Performance WPF & Silverlight Chart. 
...
{
    /// <summary>
    /// Defines a Double Delta, which provides Major and Minor deltas as used in <see cref="NumericAxis"/>
    /// </summary>
    public class DoubleAxisDelta : IAxisDelta<double>, IEquatable<DoubleAxisDelta>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleAxisDelta"/> class.
        /// </summary>
        /// <remarks></remarks>
        ...
        public object Clone()
        {
            return new DoubleAxisDelta(MinorDelta, MajorDelta);
        }
        ...
        {
            return Equals(obj as DoubleAxisDelta);
        }
