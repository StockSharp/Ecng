...
// 
// IUltrachartLicenseProvider.cs is part of Ecng.Xaml.Licensing.Core, a client-side licensing implementation 
...
{
    public interface IUltrachartLicenseProvider
    {
        /// <summary>
        /// Validates the component
        /// </summary>
        /// <param name="parameter">The component to validate</param>
        void Validate(object parameter);
    }
}