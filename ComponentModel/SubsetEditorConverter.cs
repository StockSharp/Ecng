namespace Ecng.ComponentModel
{
	...
	/// <summary>
	/// Converts from SubsetComboBox EditValue (<see cref="IEnumerable{Object}"/>) to source property type (<see cref="IEnumerable{T}"/>)
	/// </summary>
	public class SubsetEditorConverter : TypeConverter
	{
		/// <inheritdoc />
