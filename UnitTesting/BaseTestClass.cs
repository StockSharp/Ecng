...
public abstract class BaseTestClass
{
	...
	protected static T Throws<T>(Action action, string message = default)
		where T : Exception
	...
	/// <param name="message">The message to include in the exception when action does not throw.</param>
	/// <returns>The exception that was thrown.</returns>
	protected static T ThrowsExactly<T>(Action action, string message = default)
		where T : Exception
	...
	/// <param name="message">The message to include in the exception when action does not throw.</param>
	/// <returns>The exception that was thrown.</returns>
	protected static Task<T> ThrowsAsync<T>(Func<Task> action, string message = default)
		where T : Exception
	...
	/// <param name="message">The message to include in the exception when action does not throw.</param>
	/// <returns>The exception that was thrown.</returns>
	protected static Task<T> ThrowsExactlyAsync<T>(Func<Task> action, string message = default)
		where T : Exception
