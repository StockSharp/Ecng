...
namespace Hardcodet.Wpf.GenericTreeView
{
  ...
  public abstract partial class TreeViewBase<T>
  {
    ...
    #region ObserveRootItems dependency property
    ...
    public static readonly DependencyProperty ObserveRootItemsProperty;
    ...
    #region ItemFilter dependency property
    ...
    static TreeViewBase()
    {
      ...
      md = new FrameworkPropertyMetadata(true, ObserveRootItemsPropertyChanged);
      ObserveRootItemsProperty = DependencyProperty.Register("ObserveRootItems", typeof (bool), typeof (TreeViewBase<T>), md);                                                      
      ...
      md = new FrameworkPropertyMetadata(null, ItemFilterPropertyChanged);
      ItemFilterProperty = DependencyProperty.Register("ItemFilter", typeof (Predicate<T>), typeof (TreeViewBase<T>), md);                                                      
