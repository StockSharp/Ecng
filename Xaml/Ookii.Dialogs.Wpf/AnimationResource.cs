        ...
        internal SafeModuleHandle LoadLibrary()
        {
            ...
            if( handle.IsInvalid )
            {
                ...
                if( error == NativeMethods.ErrorFileNotFound )
					throw new FileNotFoundException(string.Format(System.Globalization.CultureInfo.CurrentCulture, Ecng.Xaml.Properties.Resources.FileNotFoundFormat, ResourceFile));
                else
