    ...
    public partial class ProgressDialog : Component
    {
        ...
        private void RunProgressDialog(IntPtr owner, object argument)
        {
            if( _backgroundWorker.IsBusy )
				throw new InvalidOperationException(Ecng.Xaml.Properties.Resources.ProgressDialogRunning);
            ...
            if( Animation != null )
            {
                ...
                {
					throw new InvalidOperationException(string.Format(System.Globalization.CultureInfo.CurrentCulture, Ecng.Xaml.Properties.Resources.AnimationLoadErrorFormat, ex.Message), ex);
                }
