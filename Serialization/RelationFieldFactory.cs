namespace Ecng.Serialization
{
	...
	{
		public RelationManyFieldFactory(Field field, int order, Type underlyingListType, bool bulkLoad, bool cacheCount)
			: base(field, order)
		{
	...
	public class RelationManyAttribute : RelationAttribute
	{
		...
		{
			return new object[] { UnderlyingListType, BulkLoad, CacheCount };
		}
	}
}