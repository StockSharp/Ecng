namespace Ecng.Serialization
{
	...
	public abstract class ComplexFieldFactory<TEntity> : FieldFactory<TEntity, SerializationItemCollection>
	{
		#region ComplexFieldFactory.ctor()

		protected ComplexFieldFactory(Field field, int order)
			: base(field, order)
		{
		}
